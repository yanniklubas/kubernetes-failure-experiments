...
--]]
function onCycle()
	BASE_URL = "[POST]http://REPLACE_HOSTNAME:REPLACE_PORT/"
	PREFIX_PATH = "api/shipping/confirm/anonymous-"
	JSON = '[JSON]{"distance":8271,"cost":413.55,"location":"USA Yoder"}'
end
...
function onCall(callnum)
	...
	return BASE_URL .. PREFIX_PATH .. userId .. JSON
end
